...
| 7. Vertical Slice: Features - Auth | Done | `features/auth/` api, components, schemas |
...
| 12. Cleanup Legacy Code & Build Verification | In Progress | Full bundle build passes; ESLint passes clean on all new code |
