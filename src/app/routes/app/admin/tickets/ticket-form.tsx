...
import { ClientComboBox } from "@/features/clients";
...
const formSchema = z.object({
  ...
  title: z
    ...
    .min(1, { message: "This field is required" }),
  natureOfWork: z
    .string({ required_error: "Nature of work / problem is required" })
    .min(1, { message: "This field is required" }),
  serialNo: z.string(),
  equipmentType: z
  ...
  serviceStatus: z
    .string({ required_error: "Service status is required" })
    .min(1, { message: "This field is required" }),
    ...
    if (isUpdate) {
      ...
      if (serviceEngineer) {
        ...
        serviceEngineerFullName +=
          serviceEngineer.middleName !== undefined &&
      ...
      <div className="mt-5">
        <Form {...form}>
          <form
            ...
            className="space-y-4 custom-lg:w-6/12 custom-md:w-7/12 sm:w-full"
          >
            ...
            <div className="grid gap-4 md:grid-cols-4 sm:grid-cols-1">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel
                      className={errors?.serviceStatus ? "text-red-500" : ""}
                    >
                      Service Status
                    </FormLabel>
                    <Select
            ...
            <div className="grid gap-4 md:grid-cols-2 sm:grid-cols-1">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel
                      className={errors?.defectsFound ? "text-red-500" : ""}
                    >
                      Defects Found
                    </FormLabel>
                    <FormControl>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel
                      className={errors?.serviceRendered ? "text-red-500" : ""}
                    >
                      Service Rendered
                    </FormLabel>
                    <FormControl>
            ...
            <div className="grid lg:grid-cols-2 md:grid-cols-1 gap-4">
              <FormField
                ...
                render={() => (
                  <FormItem>
                    <FormLabel className={errors?.client ? "text-red-500" : ""}>
                      Client
                    </FormLabel>
                    <FormControl>
                      <ClientComboBox
              ...
              <FormField
                ...
                render={() => (
                  <FormItem>
                    <FormLabel
                      className={errors?.serviceEngineer ? "text-red-500" : ""}
                    >
                      Service Engineer
                    </FormLabel>
                    <FormControl>
            ...
            <div className="grid">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel
                      className={errors?.remarks ? "text-red-500" : ""}
                    >
                      Remarks
                    </FormLabel>
                    <FormControl>
                      <Input
                        {...field}
                        className="h-7"
                        placeholder="Remarks / other helpful information.."
                      />
                    </FormControl>
