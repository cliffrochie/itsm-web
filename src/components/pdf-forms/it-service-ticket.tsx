...
export default function Invoice() {
  ...
  const description =
    "It says the printer end of its life service, blinking red LED.";
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        <View style={styles.header}>
          <View style={{ flexDirection: "row", gap: "2px" }}>
            ...
            >
              ...
              <Text style={{ fontSize: "9px", fontFamily: "Trajan-Pro" }}>
                REGIONAL OFFICE NO. XIII (CARAGA)
              </Text>
            </View>
          </View>
          <Image
        ...
        <View style={{ alignItems: "center", marginBottom: "13px" }}>
          <Text style={{ ...styles.fontCambriaBold, fontSize: "12px" }}>
            IT SERVICE TICKET
          </Text>
        </View>
        ...
        <View style={{ flexDirection: "row" }}>
          <View style={{ width: "250px" }}>
            <View style={{ flexDirection: "row" }}>
              <Text style={{ ...styles.fontCambria, marginRight: "8px" }}>
                ITST No.:
              </Text>
        ...
        <View
          style={{ ...styles.line, borderBottomWidth: 1, marginBottom: "4px" }}
        ></View>
        ...
        <View style={{ flexDirection: "row" }}>
          <View style={{ width: "auto" }}>
            <View style={{ flexDirection: "row" }}>
              ...
              <Text style={styles.fontCambria}>
                Ink waste pad counter reached its threshold.
              </Text>
            </View>
          </View>
        </View>
              ...
              <View style={{ marginTop: "5px" }}>
                <View style={{ flexDirection: "column", width: "250px" }}>
                  <View style={{ flexDirection: "row", width: "auto" }}>
                    <Text style={{ ...styles.fontCambria, marginRight: "5px" }}>
                      Name & Signature:
                    </Text>
                    <View
                      style={{
        ...
        <View style={{ marginBottom: "4px" }}>
          <Text style={styles.fontCambriaBold}>
        ...
        <View style={{ ...styles.fontCambria }}>
          <View style={{ flexDirection: "row", alignItems: "center" }}>
            ...
            >
              <Text style={{ width: "100%", paddingLeft: "5px" }}>
                No rating provided.
              </Text>
            </View>
          </View>
          ...
          >
            ...
            >
              <Text style={{ width: "100%", paddingLeft: "5px" }}>
                Interpreted as very dissatisfactory.
              </Text>
            </View>
          </View>
          <View
          ...
          >
            ...
            >
              <Text style={{ width: "100%", paddingLeft: "5px" }}>
                Interpreted as dissatisfactory.
              </Text>
            </View>
          </View>
          <View
