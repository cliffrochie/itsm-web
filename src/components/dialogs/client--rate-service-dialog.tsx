        ...
        <DialogHeader>
          ...
          <DialogDescription>
            <span className="text-sm font-mono">
              Service Engineer:&nbsp;{serviceEngineerName}
            </span>
          </DialogDescription>
        </DialogHeader>
        <div className="grid gap-4">
          <div className="text-sm custom-sm:text-left custom-xs:text-center text-gray-700">
            Please rate the service or support provided by the assigned service
            engineer.
          </div>
