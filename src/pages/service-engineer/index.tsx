          ...
          <div className="flex justify-center w-full">
            <Tabs defaultValue="assignedTickets" className="w-full">
              <TabsList className="grid w-full grid-cols-2 h-12">
                <TabsTrigger value="assignedTickets" className="h-10">
                  ASSIGNED TICKETS
                </TabsTrigger>
                <TabsTrigger value="closedTickets" className="h-10">
                  CLOSED TICKETS
                </TabsTrigger>
              </TabsList>
                          ...
                          assignedTickets.map((data) => (
                            ...
                            >
                              ...
                              <TableCell className="font-medium p-5 custom-sm:w-60 ">
                                <Badge
                                  variant="outline"
                                  className="hidden custom-md:inline-block border-transparent bg-gray-500 text-primary-foreground shadow hover:bg-primary/80"
                                >
