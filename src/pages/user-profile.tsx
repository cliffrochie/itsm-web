  ...
  async function onSubmitChangePassword(
    ...
    try {
      ...
      if (newPassword && newPasswordConfirm && !newPasswordsMatched) {
        errorMessages = {
          ...errorMessages,
          newPassword: "Your passwords did not match.",
        };
      } else if (
    ...
    <section className="grid gap-4">
      ...
      <div className="grid gap-2 custom-xs:grid-cols-1 custom-sm:grid-cols-[180px,auto]">
            ...
            <Button
              ...
              className={
                currentTab === "user-information"
                  ? "custom-xs:justify-center custom-sm:justify-start font-semibold bg-gray-100"
                  : "custom-xs:justify-center custom-sm:justify-start font-normal"
              }
        ...
        <div className="">
          <div
            id="user-information"
            className={currentTab === "user-information" ? "" : "hidden"}
          >
            <Card>
              <CardHeader>
          ...
          <div
            id="change-password"
            className={currentTab === "change-password" ? "" : "hidden"}
          >
            <Card>
              <CardHeader>
                <CardTitle>Change Password</CardTitle>
                <CardDescription>
                  You can change your password here by providing the necessary
                  details.
                </CardDescription>
                <CardContent>
